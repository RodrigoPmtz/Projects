...
-- Then we will union the 12 monthly data into the already created table consisting of all the bike trips of 2021

INSERT INTO Trips_2021
SELECT *
...
DELETE FROM Cyclistic..Trips_2021
WHERE DATEDIFF(MINUTE, started_at, ended_at) <= 1 OR DATEDIFF(MINUTE, started_at, ended_at) >= 1440

ALTER TABLE Trips_2021
